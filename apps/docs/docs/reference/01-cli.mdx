...
deckard 0.0.1
  ...
  deckard init <dir>          create a deck: a Next.js app with slides, a theme, and the checks
    --theme <name>               meridian, blueprint, ledger, nexus, phosphor,
                                 or quorum (default meridian)
...
"brutalist" is not a Deckard theme. The built-ins are blueprint, ledger, meridian, nexus, phosphor, quorum.
```
