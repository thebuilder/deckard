...
- my-talk/
  - app/
    - slides/
      ...
      - [id]/page.tsx
      - [id]/opengraph-image.tsx (the share card)
    - presenter/page.tsx
    - page.tsx
    - sitemap.ts
    - not-found.tsx
...
<Steps>
  ...
  <Step title="Re-export the four routes">
    ...
    The other three are `app/presenter/page.tsx`, `app/sitemap.ts`, and `app/page.tsx`. See [Route adapters](/reference/core#route-adapters). Add `app/slides/[id]/opengraph-image.tsx` for a [share card](/guides/deploying#share-cards) per slide.
