...
Slide blocks are the fourth piece, and they are not a package. They install into your app as source through a shadcn registry, and you edit them from then on.
...
<CardGroup cols={2}>
  ...
  <Card title="Theme gallery" href="/themes" icon="swatch-book">
    Six slide canvases, each painted by that theme's own stylesheet.
  </Card>
</CardGroup>
