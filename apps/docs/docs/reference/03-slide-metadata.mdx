...
description: Every field on a slide definition and a slide module, what it does, and what the defaults resolve to.
sidebar:
  icon: tags
---
...
<TypeTable
  type={{
    ...
    footer: {
      ...
      description: '"counter" resolves to "visible".',
    },
    layout: {
    ...
    background: {
      type: '"default" | "none" | "spotlight" | "grid"',
      default: '"default"',
      description: "Which background variant the theme paints. SlideBackground renders one empty element carrying data-slide-background.",
    },
    sourcePath: {
      type: "string",
