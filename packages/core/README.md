...
The route files re-export `createSlideRoute`, `createPresenterPage`, `createDeckSitemap`, and `createFirstSlideRedirect` from `@deckard/core/next`. `npx @deckard/cli init` writes all of it.
