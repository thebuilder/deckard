...
deckard 0.0.1
  ...
  deckard init <dir>          create a deck: a Next.js app with slides, a theme, and the checks
    --theme <name>               meridian, aurora, blueprint, ledger, nexus,
                                 phosphor, or quorum (default meridian)
...
deck      32 slides: 28 inline, 4 discovered
          32 slugs, 0 numbered
          canvas 1920x1080, margin 0
theme     meridian (.meridian-theme): light and dark, default system
          57 tokens in the light block, 25 dark overrides, from @deckard/themes/meridian
registry  8 items, 7 files
...
"brutalist" is not a Deckard theme. The built-ins are aurora, blueprint, ledger, meridian, nexus, phosphor, quorum.
```
