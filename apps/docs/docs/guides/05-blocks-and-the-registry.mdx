...
| `block-collections` | `collections.tsx` | `RevealList`, `BulletList`, `ContentsList`, `ColumnGrid`, `FeatureGrid`, `CardGrid`. |
...
Start with the [slide patterns gallery](/slide-patterns) when you know the job a slide has to do but not the component name. This page documents how the source files install and how their APIs compose.
