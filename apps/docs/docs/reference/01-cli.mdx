...
deckard 0.0.1
  ...
  deckard init <dir>          create a deck: a Next.js app with slides, a theme, and the checks
    --theme <name>               meridian, atelier, cotton, ledger, nexus,
                                 noir, or phosphor (default meridian)
...
"brutalist" is not a Deckard theme. The built-ins are atelier, cotton, ledger, meridian, nexus, noir, phosphor.
```
